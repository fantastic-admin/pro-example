...
import{_ as B}from"./index.vue_vue_type_script_setup_true_lang-Nx9bjpdv.js";import{_ as V}from"./index.vue_vue_type_script_setup_true_lang-CeEQmTy4.js";import{d as W,I as C,J as R,E as n,f as b,g as x,k as e,m as a,w as d,l as Y,j as r,B as s,v as f,aF as D,V as _}from"./index-DMc4HI8f.js";import{u as F}from"./watermark-CkyQYk00.js";const H=W({__name:"watermark",setup(M){const l=C(),u=F(),o=R({get(){return l.settings.app.enableWatermark},set(m){l.$patch(t=>{t.settings.app.enableWatermark=m})}});function c(){u.update({content:D().format(`YYYY-MM-DD
