...
import{d as B,I as W,J as C,E as n,e as R,f as V,g as e,a7 as b,i as a,w as d,m as x,k as r,B as s,v as _,a6 as Y,aW as D,U as f}from"./index-DOTJNdHl.js";import{u as H}from"./watermark-CSyEdX6S.js";const M=B({__name:"watermark",setup($){const l=W(),u=H(),o=C({get(){return l.settings.app.enableWatermark},set(m){l.$patch(t=>{t.settings.app.enableWatermark=m})}});function c(){u.update({content:D().format(`YYYY-MM-DD
