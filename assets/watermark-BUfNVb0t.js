...
import{d as W,J as B,K as C,G as n,f as V,g as R,h as e,a8 as b,j as a,w as d,n as x,l as r,C as s,v as f,a7 as Y,aW as D,V as c}from"./index-DuOv7Qep.js";import{u as G}from"./watermark-BnC95x0h.js";const H=W({__name:"watermark",setup(M){const l=B(),u=G(),o=C({get(){return l.settings.app.enableWatermark},set(m){l.$patch(t=>{t.settings.app.enableWatermark=m})}});function _(){u.update({content:D().format(`YYYY-MM-DD
