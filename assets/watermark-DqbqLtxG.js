...
import{d as B,J as C,K as V,G as n,f as W,g as R,h as e,a9 as Y,j as a,w as d,n as b,l as r,C as s,v as f,a8 as x,aY as D,V as c}from"./index-Dpu-vvoM.js";import{u as G}from"./watermark-Cr6AKPsw.js";const H=B({__name:"watermark",setup(M){const l=C(),u=G(),o=V({get(){return l.settings.app.enableWatermark},set(m){l.$patch(t=>{t.settings.app.enableWatermark=m})}});function _(){u.update({content:D().format(`YYYY-MM-DD
