...
import{A as e,Nt as t,O as n,Y as r,pt as i,w as a}from"./vue.runtime.esm-bundler-31VjfBU5.js";import{F as o,bt as s}from"./components-C_d7Trg8.js";import{n as c}from"./vue-i18n.runtime-BkMmoySD.js";import{t as l}from"./_demo1-Bwy63TJF.js";import{t as u}from"./_demo2-DJ9CWCsB.js";import{t as d}from"./_demo3-jlKfRH5K.js";var f=`<template>
...
`,h=e({__name:`index`,setup(e){let{t:h}=c();return(e,c)=>{let g=o,_=s;return r(),a(`div`,null,[n(g,{title:t(h)(`route.component.sparklesText`),description:`FaSparklesText`},null,8,[`title`]),n(_,{code:t(f)},{default:i(()=>[n(l)]),_:1},8,[`code`]),n(_,{title:`数量`,code:t(p)},{default:i(()=>[n(u)]),_:1},8,[`code`]),n(_,{title:`颜色`,code:t(m)},{default:i(()=>[n(d)]),_:1},8,[`code`])])}}});export{h as default};